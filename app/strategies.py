...
STRATEGIES: dict[str, dict] = {
    ...
    "martingale_hi": {
        "desc": "только смелые ставки (кэф > 2.0): после проигрыша удваиваем, после победы сброс к базовой 1% (10 от старта). Опасно: длинная серия неудач всё равно обнулит банк",
        "martingale": True,
        "base_pct": 0.01,
